package dev.alimansour.profilecardlayout
...
import dev.alimansour.profilecardlayout.ui.theme.CardColor
...
fun ProfileContent(userName: String, onlineStatus: Boolean, alignment: Alignment.Horizontal) {
    Column(modifier = Modifier.padding(8.dp), horizontalAlignment = alignment) {
...
fun UserProfileDetailsPreview() {
    ProfileCardLayoutTheme {
        UserProfileDetailsScreen(userId = 1, null)
    }
}
